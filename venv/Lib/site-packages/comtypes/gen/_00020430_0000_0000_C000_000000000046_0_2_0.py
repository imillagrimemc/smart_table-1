...
__all__ = [
    'IPictureDisp', 'OLE_XPOS_PIXELS', 'OLE_COLOR', 'FontEvents',
    'OLE_XPOS_CONTAINER', 'StdPicture', 'OLE_TRISTATE', 'Color',
    'IPicture', 'OLE_XSIZE_HIMETRIC', 'OLE_XSIZE_CONTAINER',
    'Picture', 'FONTUNDERSCORE', 'Unchecked', 'Monochrome',
    'OLE_XSIZE_PIXELS', 'OLE_YPOS_PIXELS', 'Gray',
    'FONTSTRIKETHROUGH', 'OLE_CANCELBOOL', 'IFont', 'Default',
    'OLE_OPTEXCLUSIVE', 'FONTNAME', 'OLE_YSIZE_CONTAINER',
    'OLE_YPOS_CONTAINER', 'FONTITALIC', 'VgaColor',
    'OLE_ENABLEDEFAULTBOOL', 'StdFont', 'OLE_YSIZE_HIMETRIC',
    'OLE_HANDLE', 'OLE_YPOS_HIMETRIC', 'LoadPictureConstants',
    'Checked', 'FONTSIZE', 'Font', 'OLE_YSIZE_PIXELS', 'IFontDisp',
