...
__all__ = [
    'SPEVENTSOURCEINFO', 'SAFT48kHz16BitStereo',
    'DISPID_SRRGetXMLErrorInfo', 'SpAudioFormat', 'ISpeechDataKey',
    'SpPhoneticAlphabetConverter', 'SpInProcRecoContext',
    'SPAS_CLOSED', 'DISPID_SRGCmdLoadFromMemory',
    'IInternetSecurityMgrSite', 'DISPID_SpeechPhraseRules',
    'DISPID_SPRsItem', 'SAFTADPCM_44kHzStereo', 'DISPID_SVPriority',
    'DISPID_SGRSTWeight', 'DISPID_SpeechVoiceStatus',
    'DISPID_SVEEnginePrivate', 'SGDSActiveWithAutoPause',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRCEPropertyStringChange',
    ...
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRCEPhraseStart',
    'SPRECORESULTTIMES', 'DISPID_SVGetVoices', 'DISPID_SRGetFormat',
    'SAFT32kHz8BitMono', 'DISPID_SGRSTsItem',
    'DISPID_SDKSetStringValue', 'SAFT22kHz8BitMono',
    ...
    'DISPID_SRCEInterference', 'ISpObjectWithToken',
    'SAFTCCITT_ALaw_8kHzMono', 'Speech_StreamPos_RealTime',
    'SpeechVoiceSpeakFlags', '_ISpeechVoiceEvents',
    'SAFTADPCM_8kHzMono', 'DISPID_SGRsAdd', 'ISpeechLexiconWord',
    'SP_VISEME_14', 'DISPID_SGRSAddSpecialTransition',
    'SpeechInterference', 'DISPID_SRCAudioInInterferenceStatus',
    'SPEVENTENUM', 'DISPID_SRCPause', 'SPEVENT', 'SP_VISEME_4',
    'DISPID_SBSFormat', 'DISPID_SRCEFalseRecognition',
    'eLEXTYPE_RESERVED9', 'DISPID_SpeechObjectTokenCategory',
    'ISpVoice', 'SPPHRASEELEMENT', 'SpeechPropertyResourceUsage',
    'SAFTDefault', 'ISpeechVoice', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechPropertyResponseSpeed', 'SpeechAllElements',
    'DISPID_SVESentenceBoundary', 'DISPID_SPRuleNumberOfElements',
    'IStream', 'SPDKL_LocalMachine', 'DISPID_SPAPhraseInfo',
    'SPRST_ACTIVE', 'SpeechAudioFormatGUIDWave',
    'ISpNotifyTranslator', 'DISPID_SRRecognizer', 'DISPID_SRState',
    'SWPUnknownWordPronounceable', 'DISPID_SLPSymbolic',
    'DISPID_SRGetRecognizers', 'SVSFVoiceMask', 'SINone',
    'SpPhoneConverter', 'SPWF_INPUT', 'SVP_17',
    'DISPID_SPEAudioTimeOffset', 'Speech_Default_Weight',
    'SGPronounciation', 'ISpRecoContext2', 'SPPS_RESERVED3',
    'SRTSMLTimeout', 'SpUnCompressedLexicon', 'ISpRecoContext',
    'DISPID_SRRAudioFormat', 'SAFT44kHz8BitMono', 'SRSActive',
    'SPVISEMES', 'DISPID_SGRSTText', 'DISPID_SpeechRecognizer',
    'SP_VISEME_5', 'DISPID_SLPPartOfSpeech', 'ISpeechPhraseInfo',
    'SVSFIsFilename', 'SPPHRASEPROPERTY', 'SASRun',
    'DISPID_SOTGetAttribute', 'ISpeechMMSysAudio',
    'DISPID_SpeechCustomStream', 'DISPID_SOTRemove', 'SPWORDLIST',
    'SpeechDisplayAttributes', 'SpeechEngineProperties',
    'ISpNotifySource', 'DISPID_SPEDisplayAttributes', 'SBOPause',
    ...
    'SREInterference', 'DISPID_SRRSetTextFeedback', 'SPSMF_UPS',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'DISPID_SRCEPropertyNumberChange',
    'SREAudioLevel', 'SpLexicon', 'SGSExclusive',
    'DISPID_SpeechRecoResult', 'SPPS_Noncontent',
    'DISPID_SVSLastStreamNumberQueued', 'SpMemoryStream',
    'DISPID_SpeechPhraseElement', 'SPDKL_CurrentConfig',
    'SSSPTRelativeToCurrentPosition', 'SPINTERFERENCE_TOOQUIET',
    'SAFT22kHz16BitStereo', 'DISPID_SRGCommit', 'SPPHRASEREPLACEMENT',
    'SGSDisabled', 'SREPropertyStringChange', 'SPLOADOPTIONS',
    'DISPID_SVEventInterests', 'ISpRecoGrammar2', 'SVP_9',
    'SPVPRIORITY', 'SDA_One_Trailing_Space', 'SVEPrivate', 'SPPHRASE',
    'SpeechGrammarWordType', 'SPAUDIOSTATUS', 'SP_VISEME_3',
    'SPEI_HYPOTHESIS', 'SVP_7', 'SPSEMANTICERRORINFO',
    'SPPS_Modifier', 'DISPID_SPEDisplayText', 'SASClosed',
    'DISPID_SVSRunningState', 'DISPID_SDKCreateKey', 'SP_VISEME_2',
    'DISPID_SWFEExtraData', 'SVPOver', 'SPEI_END_SR_STREAM',
    'SPEI_MIN_SR', 'SGSEnabled', 'STCRemoteServer', 'SECFIgnoreWidth',
    'SpResourceManager', 'SP_VISEME_17', 'DISPID_SMSADeviceId',
    'DISPID_SRCCmdMaxAlternates', 'SAFT48kHz16BitMono',
    'SPEI_PHRASE_START', 'DISPID_SGRAddState',
    'DISPID_SpeechMMSysAudio', 'SVP_2', 'DISPID_SRGCmdLoadFromObject',
    'SITooQuiet', 'STSF_AppData', 'DISPID_SGRSTsCount',
    'SpSharedRecoContext', 'ISpDataKey', 'ISpeechPhraseAlternates',
    'ISpeechRecoResultDispatch', 'DISPIDSPRG',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPDKL_DefaultLocation',
    'SECNormalConfidence', 'SINoSignal', 'DISPID_SPRNumberOfElements',
    'eWORDTYPE_ADDED', 'DISPID_SGRSTRule', 'DISPID_SFSOpen',
    'SSSPTRelativeToEnd', 'SAFT16kHz16BitMono', 'DISPID_SVEBookmark',
    'ISpObjectTokenCategory', 'SPEI_TTS_PRIVATE', 'DISPID_SAVolume',
    'DISPID_SPISaveToMemory', 'ISpRecognizer', 'SVSFIsXML',
    'SpeechDiscardType', 'eLEXTYPE_RESERVED6', 'eLEXTYPE_PRIVATE1',
    'DISPID_SVEStreamStart', 'SVP_20', 'DISPID_SPCLangId',
    'SP_VISEME_6', 'DISPID_SRRSaveToMemory',
    ...
    'DISPID_SPIRule', 'SpWaveFormatEx', 'SPDKL_CurrentUser',
    'SRTAutopause', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCERecognizerStateChange', 'SVPNormal',
    'DISPID_SVSLastResult', 'DISPID_SpeechVoice',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRGRules',
    'IInternetSecurityManager', 'SpeechVoicePriority',
    'Speech_StreamPos_Asap', 'SAFTCCITT_uLaw_22kHzStereo',
    'SAFT44kHz8BitStereo', 'ISpeechResourceLoader',
    'SAFTADPCM_22kHzStereo', 'SVEViseme', 'SVSFNLPMask',
    'SPSInterjection', 'DISPID_SVAudioOutput', 'SPCT_SLEEP',
    'eLEXTYPE_APP', 'SVSFParseMask', 'ISpeechRecoContext', 'ISpAudio',
    'SPAR_Low', 'DISPID_SDKEnumValues', 'DISPID_SVEAudioLevel',
    'SWTAdded', 'DISPID_SGRSTPropertyName', 'SPWT_LEXICAL',
    'SWPKnownWordPronounceable', 'DISPID_SRSetPropertyNumber',
    'DISPID_SRSSupportedLanguages', 'ISpeechRecoResult2',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SRERequestUI',
    'SAFTCCITT_uLaw_8kHzStereo', 'SECFIgnoreKanaType', 'SVP_1',
    'SVF_None', 'SVEAllEvents', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPANumberOfElementsInResult', 'SPGRAMMARWORDTYPE',
    'SpeechLexiconType', 'SAFTADPCM_11kHzMono', 'SpeechTokenKeyFiles',
    'SP_VISEME_10', 'SAFT12kHz8BitStereo', 'SPAR_High',
    'SpeechCategoryVoices', 'DISPID_SPRulesItem',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SLGetGenerationChange',
    'SpeechTokenValueCLSID', 'SAFT11kHz16BitMono',
    'eLEXTYPE_PRIVATE9', 'DISPID_SpeechPhraseAlternates',
    'SPBINARYGRAMMAR', 'SP_VISEME_19', 'DISPID_SRCESoundStart',
    'SFTInput', 'SPEI_VOICE_CHANGE', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechPhraseAlternate', 'SpeechGrammarState',
    'SPAS_PAUSE', 'ISpRecognizer2', 'DISPID_SDKGetBinaryValue',
    'SDTReplacement', 'SSTTDictation', 'SAFT48kHz8BitStereo',
    ...
    'SPPS_Noun', 'ISpeechPhraseElement', 'SRTExtendableParse',
    'DISPID_SRCERequestUI', 'DISPID_SWFEChannels',
    'SpSharedRecognizer', 'ISpGrammarBuilder',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SLPPhoneIds',
    'DISPID_SPCPhoneToId', 'STSF_FlagCreate',
    'SpeechSpecialTransitionType', 'DISPID_SpeechLexiconWords',
    'SPPHRASERULE', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SVSFParseSsml', 'SPSTREAMFORMATTYPE', 'SRESoundEnd',
    'DISPID_SPRuleFirstElement', 'SPBO_AHEAD', 'DISPID_SDKDeleteKey',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGIsPronounceable',
    'DISPID_SPPValue', 'SAFTNoAssignedFormat',
    'SDA_Two_Trailing_Spaces', 'SPEI_RECOGNITION', 'SpeechRuleState',
    'SVP_5', 'SpCustomStream', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SPEAudioSizeTime', 'DISPID_SVEVoiceChange',
    'SPEI_START_SR_STREAM', 'STSF_CommonAppData', 'ISpObjectToken',
    'DISPID_SOTSetId', 'SpeechCategoryAppLexicons',
    'SVSFPurgeBeforeSpeak', 'SBONone', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCState', 'SAFTGSM610_8kHzMono',
    'DISPID_SGRSTPropertyId', 'SPRULE', 'DISPID_SDKSetLongValue',
    'DISPID_SRGId', 'DISPID_SLPLangId', 'ISpPhraseAlt', 'SPRECOSTATE',
    'SPRST_INACTIVE', 'DISPID_SpeechLexicon',
    'DISPID_SpeechAudioFormat', 'SpeechGrammarTagUnlimitedDictation',
    'SRSEDone', 'SPADAPTATIONRELEVANCE', 'SP_VISEME_16',
    'DISPID_SRIsShared', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechPhraseProperty', 'DISPID_SRCVoice',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPINTERFERENCE_NOISE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SLWsCount',
    'SPPROPERTYINFO', 'SpeechRecognitionType', 'SPEI_UNDEFINED',
    'DISPID_SRSAudioStatus', 'DISPID_SPRFirstElement',
    'DISPID_SWFEFormatTag', 'ISpNotifySink',
    'DISPID_SRCreateRecoContext', 'SPBOOKMARKOPTIONS',
    'DISPID_SLPsItem', 'SpeechCategoryRecognizers',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SRRTStreamTime',
    'SRAInterpreter', 'SDKLDefaultLocation', 'eLEXTYPE_PRIVATE3',
    'DISPID_SDKOpenKey', 'ISpeechPhraseInfoBuilder',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRGSetTextSelection',
    '__MIDL_IWinTypes_0009', 'STCInprocServer',
    'SWPUnknownWordUnpronounceable', 'SVP_6', 'SAFTGSM610_44kHzMono',
    'ISpeechRecognizer', 'DISPID_SABIMinNotification',
    ...
    'SGLexicalNoSpecialChars', 'SVEPhoneme', 'SAFT12kHz16BitStereo',
    'SECFNoSpecialChars', 'DISPID_SMSGetData', 'ISpRecognizer3',
    'ISpeechPhraseRules', 'SpFileStream',
    'DISPID_SGRSAddRuleTransition', 'SVP_14', 'SAFT8kHz8BitStereo',
    'DISPID_SWFEBitsPerSample', 'SpeechRecoEvents',
    'DISPID_SGRsFindRule', 'DISPID_SGRSTs_NewEnum',
    'SRERecoOtherContext', 'SAFT8kHz16BitStereo',
    'SAFT24kHz16BitMono', 'SpeechRegistryUserRoot', 'SVF_Stressed',
    'SPSHORTCUTPAIR', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'eLEXTYPE_PRIVATE8', 'SPFM_CREATE', 'SAFTADPCM_8kHzStereo',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRCEEnginePrivate',
    'SPSHORTCUTTYPE', 'SVF_Emphasis', 'ISpeechPhoneConverter',
    'DISPID_SLGetWords', 'ISpeechBaseStream', 'SVEVoiceChange',
    'DISPID_SRRRecoContext', 'SVP_15', 'SPRST_NUM_STATES',
    'SPRECOGNIZERSTATUS', 'DISPID_SOTCategory', 'SRTEmulated',
    'DISPID_SASState', 'SPGS_DISABLED',
    'SpeechStreamSeekPositionType', 'DISPID_SPPEngineConfidence',
    'DISPID_SVAlertBoundary', 'DISPID_SPIAudioSizeTime', 'SRAImport',
    'eLEXTYPE_PRIVATE10', 'DISPID_SOTCId', 'DISPID_SGRsDynamic',
    'DISPID_SOTsItem', 'SpeechMicTraining', 'eLEXTYPE_RESERVED4',
    'SPWAVEFORMATTYPE', 'DISPID_SOTDisplayUI',
    'DISPID_SPRuleChildren', 'SAFT8kHz16BitMono', 'SSFMOpenReadWrite',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCERecognition',
    'SpeechGrammarTagDictation', 'SpPhraseInfoBuilder',
    'SVSFPersistXML', 'IEnumSpObjectTokens', 'DISPID_SPPFirstElement',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SVEStartInputStream',
    'eLEXTYPE_PRIVATE12', 'DISPID_SVGetAudioInputs', 'SPEI_RESERVED3',
    'SREBookmark', 'SP_VISEME_8', 'ISpeechRecoResult',
    'DISPID_SPPParent', 'SRERecognition',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SpeechPhraseInfo',
    'SAFTCCITT_uLaw_11kHzStereo', 'STCInprocHandler', 'SGLexical',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_RESERVED5',
    'DISPID_SBSSeek', 'SAFT48kHz8BitMono', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRRAlternates', 'DISPID_SpeechRecoResultTimes',
    'SPSHT_NotOverriden', 'SDA_No_Trailing_Space',
    'SPEI_RECO_STATE_CHANGE', 'SRARoot', 'SVPAlert', 'SASStop',
    'SDKLCurrentConfig', 'SPCATEGORYTYPE', 'DISPID_SpeechLexiconWord',
    'DISPID_SLPs_NewEnum', 'DISPID_SRCERecognitionForOtherContext',
    'IEnumString', 'ISpeechPhraseReplacement',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRCBookmark',
    'SPSMF_SAPI_PROPERTIES', 'SpeechAddRemoveWord',
    ...
    'DISPID_SPPNumberOfElements', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRRTTickCount', 'eLEXTYPE_PRIVATE17',
    'DISPID_SDKSetBinaryValue', 'SDTAll', 'SpeechTokenContext',
    'SGRSTTDictation', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SRCRecognizer', 'SAFT11kHz16BitStereo',
    'DISPID_SGRSTPropertyValue', 'ISpeechLexiconWords',
    'DISPID_SVSpeak', 'SSFMOpenForRead', 'ISpeechLexicon',
    'DISPID_SPPsCount', 'SRATopLevel', 'SPEI_TTS_BOOKMARK',
    'SASPause', 'ISpRecoGrammar', 'SPAR_Medium',
    'SAFT11kHz8BitStereo', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechObjectToken', 'DISPID_SRSetPropertyString',
    'eLEXTYPE_PRIVATE7', 'SREStateChange', 'SPSHT_OTHER',
    'DISPID_SRCESoundEnd', 'DISPID_SPAsItem', 'SPBO_NONE',
    'WAVEFORMATEX', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLGetPronunciations', 'SAFTADPCM_11kHzStereo',
    'ISpXMLRecoResult', 'SPAUDIOBUFFERINFO', 'SpeechCategoryAudioOut',
    'DISPID_SRGReset', 'ISpeechCustomStream', 'SpeechPartOfSpeech',
    'ISpEventSink', 'DISPID_SAFType', 'DISPID_SpeechObjectTokens',
    'DISPID_SRAudioInput', 'DISPID_SLWPronunciations', 'SPRS_ACTIVE',
    'DISPID_SGRsCommit', 'SDTDisplayText', 'SVP_3',
    'SpeechEmulationCompareFlags', 'DISPID_SRGDictationSetState',
    'SpeechRunState', 'Speech_Max_Pron_Length', 'SPAO_NONE',
    'SPEI_PHONEME', 'SVSFNLPSpeakPunc', 'SpeechAudioFormatType',
    'DISPID_SAFGuid', 'SPCT_COMMAND', 'ISpStreamFormatConverter',
    'SPBO_TIME_UNITS', 'DISPID_SRCRetainedAudio', 'DISPID_SOTId',
    'DISPID_SVSInputWordPosition', 'SpeechRuleAttributes',
    'SpeechVisemeType', 'DISPID_SPCIdToPhone',
    'SpeechPropertyComplexResponseSpeed', 'ISpShortcut',
    'eLEXTYPE_PRIVATE14', 'SPGS_EXCLUSIVE', 'DISPID_SVPause',
    'SPWORDPRONUNCIATION', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SPIProperties', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPIGetText', 'SGDSInactive', 'eLEXTYPE_PRIVATE20',
    'DISPID_SABufferNotifySize', 'DISPID_SVSLastBookmarkId',
    'SAFTExtendedAudioFormat', 'DISPID_SOTCreateInstance',
    'SPEI_RESERVED2', 'eLEXTYPE_PRIVATE11', 'SAFT11kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SVEWord',
    'SRADefaultToActive', 'DISPID_SRCRequestedUIType',
    'SAFT22kHz16BitMono', 'DISPID_SAStatus', 'ISpRecoResult',
    'SPLO_STATIC', 'DISPID_SASNonBlockingIO', 'SREPhraseStart',
    'SLOStatic', 'SPEI_SOUND_END', 'SPSEMANTICFORMAT',
    'DISPID_SLRemovePronunciation', 'ISpeechPhraseProperties',
    'SAFTText', 'DISPID_SPEPronunciation', 'SSTTWildcard',
    'SPEI_START_INPUT_STREAM', 'SGDSActive', 'SPSHORTCUTPAIRLIST',
    'SpeechAudioFormatGUIDText', 'SDTRule', 'SAFTADPCM_44kHzMono',
    'DISPID_SPAsCount', 'DISPID_SpeechBaseStream', 'SpeechTokenKeyUI',
    'SDKLCurrentUser', 'SpeechAudioVolume',
    'DISPID_SpeechPhraseReplacement', 'SPSVerb', 'SDTPronunciation',
    'DISPID_SRGState', 'DISPID_SpeechLexiconProns',
    'SPINTERFERENCE_TOOSLOW', 'SPFM_CREATE_ALWAYS',
    'SPWORDPRONOUNCEABLE', 'DISPID_SPPConfidence',
    'SPEI_FALSE_RECOGNITION',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPPS_Function',
    'STCAll', 'tagSTATSTG', 'DISPID_SRCEEndStream', 'DISPID_SPPName',
    'SP_VISEME_11', 'DISPID_SPACommit', 'DISPID_SWFEBlockAlign',
    'DISPID_SPAs_NewEnum', 'SPSUnknown', 'SVEBookmark',
    'DISPID_SGRId', 'DISPID_SDKEnumKeys', 'SpeechLoadOption',
    'DISPID_SPEs_NewEnum', 'SPAR_Unknown', 'SRSActiveAlways',
    'SPAUDIOSTATE', '_RemotableHandle', 'SRAORetainAudio',
    'DISPID_SRProfile', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCEBookmark', 'SREPropertyNumChange',
    'DISPID_SRGSetWordSequenceData', 'SITooLoud', 'SSFMCreate',
    'SpeechGrammarTagWildcard', 'SpeechVisemeFeature',
    'DISPID_SRStatus', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SVSLastBookmark', 'SpeechPropertyAdaptationOn',
    'SAFTCCITT_uLaw_22kHzMono', 'SPWF_SRENGINE',
    'SGDSActiveUserDelimited', 'DISPID_SpeechVoiceEvent',
    'ISpeechAudio', 'SREPrivate', 'DISPID_SBSWrite',
    'SPAO_RETAIN_AUDIO', 'SAFT16kHz8BitStereo', 'SPSLMA',
    'SP_VISEME_9', 'SREStreamEnd', 'SPRECOCONTEXTSTATUS',
    'ISpeechObjectTokenCategory', 'DISPID_SOTGetDescription',
    'SVP_11', 'SPINTERFERENCE_NOSIGNAL', 'SAFTCCITT_ALaw_22kHzStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SLWs_NewEnum',
    'ISpeechVoiceStatus', 'ISpeechPhraseProperty',
    'SPEI_WORD_BOUNDARY', 'DISPID_SMSALineId', 'SREAdaptation',
    'SVP_8', 'SpNullPhoneConverter', 'DISPID_SPEAudioStreamOffset',
    'ISpeechPhraseReplacements', 'DISPID_SOTMatchesAttributes',
    'DISPID_SRCCreateGrammar', 'SAFT16kHz8BitMono',
    'ISpeechWaveFormatEx', 'SDTAlternates',
    'DISPID_SPPBRestorePhraseFromMemory', 'SVSFParseSapi',
    'SAFTCCITT_ALaw_22kHzMono', 'SPVPRI_OVER', 'DISPID_SVSPhonemeId',
    'ISpSerializeState', 'SpeechWordType', 'SPFM_OPEN_READWRITE',
    'DISPID_SMSAMMHandle', 'ISpPhoneticAlphabetSelection',
    'SPSFunction', 'DISPID_SWFEAvgBytesPerSec',
    ...
    'SITooFast', 'ISpeechGrammarRules', 'ISpEventSource', 'SVP_12',
    'UINT_PTR', 'SVSFParseAutodetect', 'SpeechRecognizerState',
    'DISPID_SMSSetData', 'SGDisplay', 'DISPID_SVGetAudioOutputs',
    'DISPID_SRGRecoContext', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SPPId', 'SLTUser', 'SECLowConfidence',
    'DISPID_SpeechFileStream', 'SRAExport', 'SPRS_INACTIVE',
    'SECFDefault', 'DISPID_SPPsItem', 'SAFT44kHz16BitMono',
    'SVEAudioLevel', 'SAFT8kHz8BitMono', 'DISPID_SPILanguageId',
    'DISPID_SpeechRecoResult2', 'SPGS_ENABLED', 'SPEI_RESERVED6',
    'DISPID_SOTIsUISupported', 'SPEI_MAX_SR', 'DISPID_SOTCGetDataKey',
    'SPCS_ENABLED', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SRAudioInputStream', 'SVP_13', 'ISpeechAudioFormat',
    'SPINTERFERENCE', 'ISpeechPhraseElements', 'SPBO_PAUSE',
    'DISPID_SLGenerationId', 'SPFM_OPEN_READONLY',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPIElements', 'SpVoice',
    'DISPID_SGRsItem', 'SpStreamFormatConverter',
    'DISPID_SPRDisplayAttributes', 'SPPS_SuppressWord',
    'SpeechRecoProfileProperties', 'DISPID_SVSpeakCompleteEvent',
    'ISpRecoCategory', 'DISPID_SVSVisemeId', 'SPVPRI_NORMAL',
    'DISPID_SpeechGrammarRule',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SASetState', 'DISPID_SGRClear',
    'DISPID_SRCEventInterests', 'DISPID_SBSRead',
    'ISpeechAudioStatus', 'SPPS_LMA', 'SVP_4',
    'DISPID_SRCSetAdaptationData', 'ISpeechPhraseRule',
    'eLEXTYPE_VENDORLEXICON', 'eLEXTYPE_PRIVATE6', 'DISPID_SGRSRule',
    'DISPID_SPARecoResult', 'DISPID_SVStatus', 'SPVOICESTATUS',
    'DISPID_SPRuleConfidence', 'Speech_Max_Word_Length',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SRDisplayUI',
    'ISpPhoneConverter', 'SWTDeleted', 'SPEI_MIN_TTS',
    'SpeechPropertyLowConfidenceThreshold', 'SPWORDTYPE',
    'DISPID_SVVoice', 'SVSFIsNotXML', 'SpeechFormatType',
    'DISPID_SCSBaseStream', 'ISpeechPhraseAlternate',
    'STCLocalServer', 'DISPID_SREmulateRecognition',
    'ISpeechRecognizerStatus', 'DISPID_SVSkip', 'SPSHT_Unknown',
    'SP_VISEME_7', 'SP_VISEME_18', 'ISpeechXMLRecoResult',
    'SREFalseRecognition', 'SpeechAudioState', 'SAFT12kHz8BitMono',
    'SpMMAudioEnum', 'SPCT_SUB_COMMAND', 'DISPID_SRGDictationLoad',
    'SpeechRetainedAudioOptions', 'SRESoundStart',
    'SPWT_PRONUNCIATION', 'SECHighConfidence', 'DISPID_SOTCDefault',
    'SPSNoun', 'SpeechTokenShellFolder', 'SpStream', 'SRCS_Disabled',
    'SpeechUserTraining', 'SLTApp', 'eLEXTYPE_RESERVED10',
    'SpeechDictationTopicSpelling', 'SVP_18', 'DISPID_SVVolume',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SPRuleParent', 'SP_VISEME_13',
    'DISPID_SGRSTNextState', 'SGRSTTWildcard', 'SDTLexicalForm',
    'DISPID_SRCEAdaptation', 'SPAS_RUN', 'SRAONone',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechPhoneConverter',
    'SPEI_ADAPTATION', 'ISpeechRecoResultTimes', 'SPPS_RESERVED2',
    'DISPID_SPEsItem', 'DISPID_SRGetPropertyNumber',
    'DISPID_SpeechGrammarRules', 'SRSInactiveWithPurge',
    'SAFT24kHz8BitStereo', 'SDKLLocalMachine', 'LONG_PTR',
    'SPXRO_SML', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechAudioBufferInfo', 'SDTProperty', 'eWORDTYPE_DELETED',
    'DISPID_SpeechRecoContext', 'eLEXTYPE_PRIVATE4', 'SP_VISEME_0',
    'DISPID_SPRsCount', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGCmdSetRuleState', 'SpShortcut',
    'DISPID_SVSInputSentenceLength', 'SPWORD',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SpeechAudioStatus',
    'SPCONTEXTSTATE', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE18', 'SPPS_NotOverriden', 'DISPID_SPEsCount',
    'DISPID_SASFreeBufferSpace', 'SVP_0', 'SECFIgnoreCase',
    'SP_VISEME_20', 'eLEXTYPE_MORPHOLOGY', 'SAFT32kHz16BitMono',
    'SPSSuppressWord', 'SpeechTokenIdUserLexicon',
    'DISPID_SpeechDataKey', 'SVP_19', 'SAFTNonStandardFormat',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SFSClose',
    'DISPID_SPRuleId', 'SAFTGSM610_22kHzMono',
    'DISPID_SPIAudioSizeBytes', 'SAFTADPCM_22kHzMono',
    'SPCT_SUB_DICTATION', 'DISPID_SVSCurrentStreamNumber',
    'SpCompressedLexicon', 'SpObjectTokenCategory', 'SpObjectToken',
    'SpInprocRecognizer', 'DISPIDSPTSI_SelectionOffset',
    'SPLEXICONTYPE', 'ISpeechFileStream', 'DISPID_SDKDeleteValue',
    'ISpeechTextSelectionInformation', 'SRTReSent', 'SpMMAudioIn',
    'DISPID_SpeechPhraseElements',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SGRs_NewEnum',
    'SpeechVoiceCategoryTTSRate', 'SSTTTextBuffer', 'DISPID_SVRate',
    'DISPID_SLWWord', 'ISpeechRecoGrammar', 'SP_VISEME_1',
    'DISPID_SOTs_NewEnum', 'SVSFDefault', 'SAFT24kHz16BitStereo',
    'SAFT24kHz8BitMono', 'DISPID_SGRSTransitions',
    'SpeechCategoryPhoneConverters', 'ISpPhrase',
    'SpeechRecoContextState', 'DISPID_SVDisplayUI',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SLAddPronunciation',
    'SpeechTokenKeyAttributes', 'SDTAudio', 'SPPS_Verb',
    'DISPID_SRGDictationUnload', 'SVESentenceBoundary',
    'DISPID_SPRuleName', 'eLEXTYPE_PRIVATE5', 'SPEI_RESERVED1',
    'SVP_21', 'SPEI_VISEME', 'SPPS_RESERVED4', 'ISpProperties',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVSFUnusedFlags',
    'DISPID_SVSInputSentencePosition', 'DISPID_SGRName',
    'SAFT16kHz16BitStereo', 'DISPID_SRCEHypothesis',
    '_ISpeechRecoContextEvents', 'tagSPPROPERTYINFO',
    'SVEEndInputStream', 'SRSInactive', 'SAFT32kHz16BitStereo',
    'ISequentialStream', 'ISpLexicon', 'DISPID_SLPType',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SOTDataKey',
    'DISPID_SWFESamplesPerSec', 'SPEI_REQUEST_UI',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SOTCSetId', 'SAFT12kHz16BitMono',
    'SPEI_SR_PRIVATE', 'SpeechCategoryRecoProfiles',
    'ISpeechGrammarRule', 'SPEI_SR_BOOKMARK', 'SAFT44kHz16BitStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'DISPID_SPPChildren', 'DISPID_SRCResume',
    'DISPID_SAFSetWaveFormatEx', 'SGRSTTEpsilon', 'DISPIDSPTSI',
    'DISPID_SABIBufferSize', 'DISPID_SOTsCount', 'STSF_LocalAppData',
    'DISPID_SpeechRecognizerStatus', 'SRSEIsSpeaking',
    'SPPARTOFSPEECH', 'SPSERIALIZEDPHRASE', 'DISPID_SVResume',
    'DISPID_SRRPhraseInfo', 'DISPID_SVEStreamEnd',
    'DISPID_SADefaultFormat', 'DISPID_SPELexicalForm', 'SPWT_DISPLAY',
    'eLEXTYPE_PRIVATE15', 'SPINTERFERENCE_NONE',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SVWaitUntilDone',
    'DISPID_SLPsCount', 'SpeechBookmarkOptions', 'SGRSTTRule',
    'SpeechDataKeyLocation', 'SVP_10', 'SPEI_SENTENCE_BOUNDARY',
    'DISPID_SGRSTType', 'DISPID_SRRAudio', 'SPDATAKEYLOCATION',
    'SITooSlow', 'ISpeechObjectTokens',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SpeechAudio',
    'DISPID_SPERetainedSizeBytes', 'ISpStream',
    'DISPID_SVSInputWordLength', 'SPEI_TTS_AUDIO_LEVEL',
    'SRTStandard', 'ISpeechLexiconPronunciation', 'DISPID_SRRTimes',
    'SpMMAudioOut', 'SPEI_END_INPUT_STREAM',
    'SpeechPropertyHighConfidenceThreshold', 'SPSHT_EMAIL',
    'DISPID_SpeechPhraseReplacements', 'SVEWordBoundary',
    'SRADynamic', 'DISPID_SGRInitialState', 'SPCS_DISABLED',
    'SPTEXTSELECTIONINFO', 'DISPID_SRSCurrentStreamPosition',
    'SREStreamStart', 'SRCS_Enabled',
    'DISPID_SRCCreateResultFromMemory', 'SPXMLRESULTOPTIONS',
    'DISPID_SABufferInfo', 'SPGRAMMARSTATE', 'DISPID_SABIEventBias',
    'DISPID_SpeechPhraseBuilder', 'SLODynamic', 'SPFILEMODE',
    'DISPID_SAEventHandle', 'DISPID_SRCEAudioLevel',
    'DISPID_SVEViseme', 'SPSERIALIZEDRESULT', 'SINoise',
    'DISPID_SVGetProfiles', 'SPAUDIOOPTIONS', 'SPSNotOverriden',
    'SpeechCategoryAudioIn', 'SPEI_SOUND_START',
    'SpeechStreamFileMode', 'DISPID_SPRText', 'DISPID_SVEPhoneme',
    'DISPID_SRGCmdLoadFromResource', 'SFTSREngine', 'DISPID_SLWsItem',
    'SpTextSelectionInformation', 'SVSFlagsAsync', 'DISPID_SLWType',
    'SPPS_Unknown', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SVIsUISupported', 'DISPID_SRRTLength',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPCT_DICTATION', 'eLEXTYPE_PRIVATE13',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpMMSysAudio',
    'DISPID_SRSClsidEngine', 'eLEXTYPE_PRIVATE19', 'SP_VISEME_21',
    'DISPID_SGRAttributes', 'SPPS_Interjection', '_SPAUDIOSTATE',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SRRDiscardResultInfo',
    'SPRULESTATE', 'SPINTERFERENCE_TOOFAST', 'DISPID_SPRulesCount',
    'DISPID_SPIEngineId', 'DISPID_SRIsUISupported', 'SP_VISEME_12',
    'SSFMCreateForWrite', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPIGrammarId', 'SPLO_DYNAMIC', 'SPAS_STOP',
    'DISPID_SpeechPhraseRule', 'SPPS_RESERVED1', 'SVP_16',
    'eLEXTYPE_USER', 'DISPID_SGRAddResource',
    'DISPID_SRGCmdSetRuleIdState', 'DISPID_SRRGetXMLResult',
    'SPRST_INACTIVE_WITH_PURGE', 'SpeechWordPronounceable',
    'SPVPRI_ALERT', 'SGRSTTWord', 'DISPID_SDKGetlongValue',
    'ISpResourceManager', 'SPXRO_Alternates_SML',
    'SAFT32kHz8BitStereo', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_PRIVATE2', 'SREHypothesis', 'DISPID_SRRSpeakAudio',
    'SAFT22kHz8BitStereo', 'SPSModifier',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_INTERFERENCE'
]
